...
public class VlcVideoActivity extends Activity implements SurfaceHolder.Callback,
        IVideoPlayer, View.OnClickListener {
    public final static String TAG = VlcVideoActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vlc_player_activity);

        // Receive path to play from intent
        Intent intent = getIntent();
        mFilePath = intent.getExtras().getString(EXTRA_URL);
     ...
     * Events
     *************/
    private Handler mHandler = new MyHandler(VlcVideoActivity.this);
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(VlcVideoActivity owner) {
